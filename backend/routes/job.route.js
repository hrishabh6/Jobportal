...
import { deleteJob, getAllJobs, getJobForAParticularCompany, getjobsById, getJobsForRecruiter, jobStatus, jobTitles, postJob } from '../controllers/job.controller.js';
const router = express.Router();

router.route('/post').post(isAuthenticated, postJob)
router.route('/get').post(getAllJobs)
router.route('/get/title').get(jobTitles)
